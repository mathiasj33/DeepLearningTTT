...
def load_image(path, mean_image, height, width, mode='RGB'):
    """
    ...
    #===========================================================================
    # mean_image = PIL.Image.open(mean_image)
    # mean_image = mean_image.convert(mode)
...
def classify(caffemodel, deploy_file, image_files,
             mean_file=None, labels_file=None, batch_size=None, use_gpu=True, mean_image=None):
    """
    ...
    images = [load_image(image_file, mean_image, height, width, mode) for image_file in image_files]
